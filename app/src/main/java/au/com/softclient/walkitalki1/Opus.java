...
//    public static final Opus INSTANCE = (Opus) Native.loadLibrary("opus", Opus.class);
//
...
//
//    byte[] opus_encode(byte[] buffer, Constants.FrameSize frameSize);
//
//    byte[] opus_custom_decode(byte[] encodedData, Constants.FrameSize frameSize);
//
